...
なお、Issue [#464](https://github.com/chirimen-oh/chirimen-drivers/issues/464) でも触れられている通り、実務上は I2C デバイスドライバに限らず、サンプル単体・デバイス単体でのコントリビューションもあり得ますが、これら単体向けのガイドは現時点では未整備です。
