...
class BME280 {
   ...
   * @param {number} [slaveAddress=0x77] - I2C slave address
   */
  ...
  /**
   * Read sensor data (legacy method)
   ...
   * @returns {Promise<{temperature: number, pressure: number, humidity: number}>}
   */
  async readData() {
    var data = [];
    var dat;
