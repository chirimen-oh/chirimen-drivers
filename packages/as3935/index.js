...
class AS3935 {
  ...
  async set_noise_floor(noisefloor) {
  ...
  async lower_noise_floor(min_noise) {
  ...
  async raise_noise_floor(max_noise) {
  ...
  async set_min_strikes(minstrikes) {
  ...
  async set_mask_disturber(mask_dist) {
  ...
  async set_disp_lco(display_lco) {
