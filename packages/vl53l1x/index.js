...
class VL53L1X {
  ...
  async readResults() {
    ...
    this.results.ambient_count_rate_mcps_sd0 |= readData[8]; // low byte
  ...
  async writeReg32Bit(addr16, dat32) {
    await this.i2cSlave.writeBytes([
      addr16 >>> 8,
      addr16 & 0xff,
      dat32 >>> 24,
  ...
  countRateFixedToFloat(count_rate_fixed) {
