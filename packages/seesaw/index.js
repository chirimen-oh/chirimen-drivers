...
class Seesaw {
  ...
  async _pin_mode_bulk_x(capacity, offset, pins, mode) {
  ...
  async pin_mode_bulk(pins, mode) {
    await this._pin_mode_bulk_x(4, 0, pins, mode);
  }
  /**
  async pin_mode_bulk_b( pins, mode) {
        await this._pin_mode_bulk_x(8, 4, pins, mode)
  }
  **/
  async digital_write(pin, value) {
  ...
  async digital_write_bulk(pins, value) {
  ...
  async initNeopixel(pin, quantity, auto_write, pixel_order) {
  ...
  async setPixels_int(offset, rgbArray) {
  ...
  async setPixels(offset, rgbArray) {
  ...
  // ===============================================================
  // more low level func
  async readReg8(baseAddr, funcAddr, delay) {
  ...
  async writeReg8(baseAddr, funcAddr, data8) {
  ...
  async readReg16(baseAddr, funcAddr, delay) {
    await this.i2cSlave.writeBytes([baseAddr & 0xff, funcAddr & 0xff]);
    if (delay) {
      await sleep(delay);
    } else {
  ...
  async writeReg16(baseAddr, funcAddr, data16) {
  ...
  async readReg24(baseAddr, funcAddr, delay) {
    await this.i2cSlave.writeBytes([baseAddr & 0xff, funcAddr & 0xff]);
    if (delay) {
      await sleep(delay);
    } else {
  ...
  async writeReg24(baseAddr, funcAddr, data24) {
    await this.i2cSlave.writeBytes([
      baseAddr & 0xff,
      funcAddr & 0xff,
      (data24 >>> 16) & 0xff,
  ...
  async readReg32(baseAddr, funcAddr, delay) {
  ...
  async writeReg32(baseAddr, funcAddr, data32) {
  ...
  async readRegN(baseAddr, funcAddr, readByteLength, delay) {
    await this.i2cSlave.writeBytes([baseAddr & 0xff, funcAddr & 0xff]);
    if (delay) {
      await sleep(delay);
    } else {
  ...
  async writeRegN(baseAddr, funcAddr, dataBytes) {
