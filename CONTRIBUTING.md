...
Issue [#464](https://github.com/chirimen-oh/chirimen-drivers/issues/464) でも整理されている通り、実務上は I2C デバイスドライバ追加だけでなく、サンプル単体・デバイス単体でのコントリビューションもあり得ます。ただし現時点では、これら単体向けのコントリビューションガイドは本リポジトリ側に整備されていません。
